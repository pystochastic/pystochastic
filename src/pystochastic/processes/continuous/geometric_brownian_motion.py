...
from pystochastic.utils import generate_times
from pystochastic.utils.validation import check_numeric
from pystochastic.utils.validation import check_positive_integer
