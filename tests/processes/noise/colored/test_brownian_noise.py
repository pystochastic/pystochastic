...
from pystochastic.processes.noise import BrownianNoise as TestType


def test_brownian_noise_str_repr() -> None:
...
def test_brownian_noise_sample_shape() -> None:
...
def test_brownian_noise_sample_values(
    t: float,
    n: int,
    expected: list[float],
) -> None:
